...
./bin/kmeans_spf seq 5 10 2048 datasets/input2048.data
./bin/kmeans_spf seq 5 10 16384 datasets/input16384.data
./bin/kmeans_spf seq 5 10 1966080 datasets/input1966080.data
./bin/kmeans_spf seq 5 10 62914560 datasets/input62914560.data